# -*- coding: utf-8 -*-
"""
Created on Sat Sep  5 23:08:58 2020
...
def main():
    ...
    def load_data():
        data = pd.read_csv(r"C:\Users\Toshita Sharma\Desktop\webapp\mushrooms.csv")
...
#plotting the different types of curves according to the user selection    
...
#different machine learning algorithms with specifications on hyperparameters
    ...
    if classifier == 'Random Forest':
        ...
        if st.sidebar.button("Classify", key='classify'):
            ...
            st.write("Recall: ", recall_score(y_test, y_pred, labels=class_names).round(2))
            plot_metrics(metrics)
#display of the dataset on user choice 
